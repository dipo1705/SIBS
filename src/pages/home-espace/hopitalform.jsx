...
function HopitalForm() {
    return (
      <form class="w-full max-w-lg pt-2 pb-10">
      <h1 class=" pt-3 pb-0 bg-gray-300 bg-red-600 text-center text-white" >Vous êtes un Hôpital, inscrivez-vous,</h1>
        <h1 class=" pt-0 pb-10 bg-gray-300 bg-red-600 text-center text-white" >pour achèter des produits sanguins</h1>
